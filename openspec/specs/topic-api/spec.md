...
## Purpose
HTTP endpoint handlers for Topic CRUD operations (GET /topics, POST /topics, GET /topics/{id}), including query/path parameter extraction, request validation, error responses, and route registration.

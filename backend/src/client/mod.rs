    ...
    B::Error: Into<Box<dyn Error + Send + Sync>>,
{
    ...
    async fn create_daily_track(
        &self,
        param_body: models::CreateDailyTrackRequest,
        ...
        *request.body_mut() = body_from_string(body);
        ...
        match response.status().as_u16() {
            201 => {
                ...
                let body = serde_json::from_str::<models::DailyTrack>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;


                Ok(CreateDailyTrackResponse::DailyTrackRecordCreatedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(CreateDailyTrackResponse::InvalidInput
                    (body)
                )
            }
            404 => {
                ...
                Ok(CreateDailyTrackResponse::ReferencedTopicNotFound
                    (body)
                )
            }
            409 => {
                ...
                Ok(CreateDailyTrackResponse::ARecordAlreadyExistsForThisTimePeriod
                    (body)
                )
            }
            500 => {
                ...
                Ok(CreateDailyTrackResponse::InternalServerError
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetDailyTracksResponse, ApiError>
    {
        ...
        let query_string = {
            ...
            if let Some(param_topic_id) = param_topic_id {
                query_string.append_pair("topic_id",
                    &param_topic_id.to_string());
            }
            query_string.finish()
        };
        if !query_string.is_empty() {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<Vec<models::DailyTrack>>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;


                Ok(GetDailyTracksResponse::SuccessfulOperation
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetDailyTracksResponse::InvalidDateFormatOrParameters
                    (body)
                )
            }
            500 => {
                ...
                Ok(GetDailyTracksResponse::InternalServerError
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetDailyTrackByIdResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetDailyTrackByIdResponse::SuccessfulOperation
                    (body)
                )
            }
            404 => {
                ...
                Ok(GetDailyTrackByIdResponse::DailyTrackRecordNotFound
                    (body)
                )
            }
            500 => {
                ...
                Ok(GetDailyTrackByIdResponse::InternalServerError
                    (body)
                )
            }
            code => {
    ...
    async fn create_topic(
        &self,
        param_body: models::CreateTopicRequest,
        ...
        *request.body_mut() = body_from_string(body);
        ...
        match response.status().as_u16() {
            201 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::Topic>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;


                Ok(CreateTopicResponse::TopicCreatedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(CreateTopicResponse::InvalidInput
                    (body)
                )
            }
            409 => {
                ...
                Ok(CreateTopicResponse::TopicNameAlreadyExists
                    (body)
                )
            }
            500 => {
                ...
                Ok(CreateTopicResponse::InternalServerError
                    (body)
                )
            }
            code => {
    ...
    async fn get_topics(
        &self,
        param_parent_topic_id: Option<i64>,
        context: &C) -> Result<GetTopicsResponse, ApiError>
    {
        ...
        let query_string = {
            let mut query_string = form_urlencoded::Serializer::new("".to_owned());
            if let Some(param_parent_topic_id) = param_parent_topic_id {
                query_string.append_pair("parent_topic_id",
                    &param_parent_topic_id.to_string());
            }
            query_string.finish()
        };
        if !query_string.is_empty() {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<Vec<models::Topic>>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;
            ...
            500 => {
                ...
                Ok(GetTopicsResponse::InternalServerError
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetTopicByIdResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetTopicByIdResponse::SuccessfulOperation
                    (body)
                )
            }
            404 => {
                ...
                Ok(GetTopicByIdResponse::TopicNotFound
                    (body)
                )
            }
            500 => {
                ...
                Ok(GetTopicByIdResponse::InternalServerError
                    (body)
                )
            }
            code => {

...
**updated_at** | [**chrono::DateTime::<chrono::Utc>**](DateTime.md) | Timestamp when the record was last updated | [optional] [default to None]
**topic_id** | **i64** | ID of the associated topic | [optional] [default to None]
